    ...
    <div className="min-h-screen flex flex-col items-center justify-center py-10 mt-20">
        ...
        <div className="flex flex-col lg:flex-row items-center lg:space-x-16  mt-10">
          <div className="lg:w-3/4 text-center lg:text-left p-6 ">
            ...
            <p className="sm:text-base md:text-lg lg:text-lg  leading-relaxed mb-3">
              FreeSWITCH is an open source communications platform. It has many
              ...
              FreeSWITCH programmers from Ayanshtech who have mastered the
              subject. Our team understands the architecture and platform
              know-how, allowing us to provide professional FreeSWITCH solution
              development services. We can work around the clock to develop a
              FreeSWITCH solution, whether you require a single tenant to
              improve business communication or a multitenant to establish a new
              business. FreeSWITCH software Development is amongst the fastest
              growing technologies that encapsulates a range of benefits.
            </p>
      ...
      <div className="text-center mb-5 mt-20">
        <h2 className="sm:text-3xl md:text-4xl lg:text-5xl font-bold text-gray-800">
          Expertise of Our FreeSWITCH Developers
        </h2>
        <p className="sm:text-base md:text-lg lg:text-xl text-gray-600 font-semibold mt-4 max-w-6xl mx-auto">
          Ayanshtech Solutions provides complete FreeSWITCH development
          services, including module development and customization.
        </p>
      </div>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
          <div className="flex items-center space-x-4">
            <img
              ...
              className="w-14 h-14"
            />
            <p className="text-lg">Freeswitch XML Dialplan Configurations</p>
          </div>
          ...
          <div className="flex items-center space-x-4">
            <img
              ...
              className="w-14 h-14"
            />
            <p className="text-lg">Ability to set up FreeSWITCH Cluster</p>
          </div>
          ...
          <div className="flex items-center space-x-4">
            <img
              ...
              className="w-14 h-14"
            />
            <p className="text-lg">Proficient Knowledge of Lua Scripting</p>
          </div>
          ...
          <div className="flex items-center space-x-4">
            <img
              ...
              className="w-14 h-14"
            />
            <p className="text-lg">Expert Knowledge of SIP/SDP/RTP protocols</p>
          </div>
          ...
          <div className="flex items-center space-x-4">
            <img
              ...
              className="w-14 h-14"
            />
            <p className="text-lg">Expert Knowledge of FreeSWITCH Modules</p>
          </div>
        </div>
      </div>
      ...
      <div className="text-center mb-5 mt-20">
        <h2 className="sm:text-3xl md:text-4xl lg:text-5xl font-bold text-gray-800">
          Hire Seasoned FreeSWITCH Developers
        </h2>
        <p className="sm:text-base md:text-lg lg:text-xl text-gray-600 font-semibold mt-4 max-w-6xl mx-auto">
          We can transform your dream project with our FreeSWITCH development
          experts.
        </p>
      </div>
        ...
        <div className="flex flex-col md:flex-row items-center justify-between">
          ...
          <div className=" md:w-1/2 lg:w-3/4 p-4 grid grid-cols-1 md:grid-cols-2 gap-6">
            <div className="flex items-start space-x-4">
              ...
              <div>
                <p className="text-lg">Multi-tenant architecture expertise</p>
              </div>
            </div>
            ...
            <div className="flex items-start space-x-4">
              ...
              <div>
                <p className="text-lg">
                  Flexible development team to create a wide range of
            ...
            <div className="flex items-start space-x-4">
              ...
              />
              <div>
                <p className="text-lg">Rapid technological solutions</p>
              </div>
            </div>
          </div>
        </div>
...
export default FreeSwitchDevelopers;
