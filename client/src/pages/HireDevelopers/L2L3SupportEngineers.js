...
import { L2L3SupportEngineerFaqs } from "../../components/faqData.js";

import Contact from "../../components/Contact.js";
import GetInTouch from "../../components/GetInTouch.js";
import AyanshtechAdvantage from "../../components/AyanshtechAdvantage.js";

const L2L2SupportEngineers = () => {
    ...
    <div className="min-h-screen flex flex-col items-center justify-center py-10 mt-20">
        ...
        <div className="flex flex-col lg:flex-row items-center lg:space-x-16 ml-10 mt-10">
          <div className="lg:w-3/4 text-center lg:text-left ">
            ...
            <p className="sm:text-base md:text-lg lg:text-lg  leading-relaxed mb-3">
              We never let a problem go unsolved when it comes to us. Hire L2/L3
              Support Engineers from us who will take care of any escalated
          ...
          <div className="flex justify-center  mb-12 lg:mb-0 mt-5">
            <img
              src="\assets\images\headerSection\hireL2L3SupportEng\img1.png"
      ...
      <div className="text-center mb-5 mt-20">
        ...
        <p className="sm:text-base md:text-lg lg:text-xl text-gray-600 font-semibold mt-4 max-w-6xl mx-auto">
          When you hire an L2/L3 Support Engineer with us, they will provide the
          following services regarding VoIP solutions.
        </p>
      </div>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
          <div className="flex items-center space-x-4">
            <img
              ...
              className="w-14 h-14"
            />
            <p className="text-lg">Advanced Repair/Troubleshooting</p>
          </div>
          ...
          <div className="flex items-center space-x-4">
            <img
              ...
              className="w-14 h-14"
            />
            <p className="text-lg">Monitoring of batches/infrastructure</p>
          </div>
          ...
          <div className="flex items-center space-x-4">
            <img
              ...
              className="w-14 h-14"
            />
            <p className="text-lg">Configuration Management</p>
          </div>
          ...
          <div className="flex items-center space-x-4">
            <img
              ...
              className="w-14 h-14"
            />
            <p className="text-lg">Automation Process</p>
          </div>
          ...
          <div className="flex items-center space-x-4">
            <img
              ...
              className="w-14 h-14"
            />
            <p className="text-lg">Analysis of the Causes</p>
          </div>
          <div className="flex items-center space-x-4">
            <img
              src="/assets/icons/consultancyDiscovery/1.svg"
              ...
              className="w-14 h-14"
            />
            <p className="text-lg">Trends/Incident Analysis</p>
          </div>
        </div>
      </div>
      ...
      <div className="text-center mb-5 mt-20">
        ...
        <p className="sm:text-base md:text-lg lg:text-xl text-gray-600 font-semibold mt-4 max-w-6xl mx-auto">
          ...
          that aren’t covered by L1 Technical Support or that they haven’t been
          able to resolve after multiple efforts.
        </p>
      </div>
      ...
      <div className="bg-white p-4">
        <div className="flex flex-col md:flex-row items-center justify-between">
          <div className="w-full md:w-1/3 p-4">
            <img
              src="\assets\images\headerSection\hireL2L3SupportEng\img2.png"
          ...
          <div className=" md:w-1/2 lg:w-3/4 p-4 grid grid-cols-1 md:grid-cols-2 gap-6">
            <div className="flex items-start space-x-4">
              ...
              <div>
                <p className="text-lg">
                  Knowledgeable and skilled in a variety of troubleshooting
                  procedures.
                </p>
              </div>
            </div>
            ...
            <div className="flex items-start space-x-4">
              ...
              <div>
                <p className="text-lg">
                  Advanced VoIP issues can be resolved with minimum effort.
                </p>
              </div>
            </div>
            ...
            <div className="flex items-start space-x-4">
              ...
              <div>
                <p className="text-lg">
                  Understanding of current events and analysis of incidents.
                </p>
              </div>
            </div>
            <div className="flex items-start space-x-4">
              ...
              <div>
                <p className="text-lg">
                  Monitoring infrastructure and batches.
                </p>
              </div>
            </div>
            <div className="flex items-start space-x-4">
              ...
              <div>
                <p className="text-lg">
                  Performance tweaking to guarantee that all VoIP network
            ...
            <div className="flex items-start space-x-4">
              ...
              <div>
                <p className="text-lg">
                  Analysis of the root cause and recommendations for preventing
                  recurrence.
                </p>
              </div>
            </div>
      ...
      <div className="max-w-3xl mx-auto p-6 py-20 w-full ">
        ...
        {L2L3SupportEngineerFaqs.map((faq, index) => (
...
export default L2L2SupportEngineers;
