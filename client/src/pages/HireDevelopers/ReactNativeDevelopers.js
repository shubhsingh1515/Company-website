...
import { reactNativeDevFaqs } from "../../components/faqData.js";
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
          <div className="flex items-center space-x-4">
            <img
              ...
              className="w-14 h-14"
            />
            <p className="text-lg">Hybrid / Cross-Platform Developmen</p>
          </div>
          ...
          <div className="flex items-center space-x-4">
            <img
              ...
              className="w-14 h-14"
            />
            <p className="text-lg">Development of React Native Apps</p>
          </div>
...
Apps are easily adaptable and scalable to meet the changing needs of enterprises.
      ...
      <div className="max-w-3xl mx-auto p-6 py-20 w-full ">
        ...
        {reactNativeDevFaqs.map((faq, index) => (
