    ...
    <div className="bg-gray-100">
      ...
      >
        {services.map((service, index) => (
          <div
            key={index}
            className={`flex items-center space-x-4 bg-white p-4 rounded-md shadow-sm transition-transform duration-300 ${
      ...
      {/* Contact Information */}
      <div className="max-w-7xl mx-auto grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-6 py-8">
